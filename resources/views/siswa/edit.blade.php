    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('siswa.update', $user->username) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <a href="{{ route('siswa.index') }}" class="btn btn-sm btn-danger"><i class="bi bi-x-circle"></i> Batal</a>
