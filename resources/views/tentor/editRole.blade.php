    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                ...
                <form action="{{ route('tentor.upRole', $user->username) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <a href="{{ route('tentor.show', $user->username) }}" class="btn btn-sm btn-danger"><i class="bi bi-x-circle"></i> Batal</a>
