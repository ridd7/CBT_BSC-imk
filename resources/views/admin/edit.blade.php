    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('admin.update', $user->username) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <a href="{{ route('admin.index') }}" class="btn btn-sm btn-danger"><i class="bi bi-x-circle"></i> Batal</a>
