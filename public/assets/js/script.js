...
function soal() {
    ...
    const imgPreview = document.querySelector('.soal-preview');
...
function pilA() {
    const image = document.querySelector('#gambar_pil_a');
    const imgPreview = document.querySelector('.pil-a-preview');
...
function pilB() {
    const image = document.querySelector('#gambar_pil_b');
    const imgPreview = document.querySelector('.pil-b-preview');
...
function pilC() {
    const image = document.querySelector('#gambar_pil_c');
    const imgPreview = document.querySelector('.pil-c-preview');
...
function pilD() {
    const image = document.querySelector('#gambar_pil_d');
    const imgPreview = document.querySelector('.pil-d-preview');
...
function pilE() {
    const image = document.querySelector('#gambar_pil_e');
    const imgPreview = document.querySelector('.pil-e-preview');
